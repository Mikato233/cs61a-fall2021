...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while True:
            if cur_place.is_hive or distance > self.max_range:
                return None
            elif distance >= self.min_range:
                the_bee = random_bee(cur_place.bees)
                if the_bee: 
                    return the_bee
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        real_damage = amount + (amount >= self.health) * self.damage
...
class WallAnt(Ant):
    """Wall does nothing each tuen but has a large health value!"""
...
class HungryAnt(Ant):
    """HungryAnt eats a bee in its place."""
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        while cur_place:
            buff_ant = cur_place.ant
            if buff_ant:
                buff_ant.buff()
                if buff_ant.is_container and buff_ant.ant_contained:
                    buff_ant.ant_contained.buff()
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        elif gamestate.time % 2 == 1 and self.slowed_turns > 0: # can't move! #
            pass            
    ...
    def insects_in_front(self):
        ...
        while not cur_place.is_hive:
            ...
            if cur_place.ant is not None:
                ...
                if cur_place.ant.is_container and cur_place.ant.contained_ant and cur_place.ant.contained_ant is not self:
