...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        oc = opponent_card
        oc.attack -= oc.defense
        if oc.attack < 0: oc.attack = 0
        oc.defense *= 2
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        oc = opponent_card
        oc.attack, oc.defense = oc.defense, oc.attack
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        for card in player.deck.cards:
            card.attack += oc.attack
            card.defense += oc.defense
        copy_cards = opponent.deck.cards[:]
        opponent.deck.cards = list(filter(lambda card: card.attack != oc.attack and card.defense != oc.defense, copy_cards))
        # You should add your implementation above this.
